    ...
    public function read(){
        try{
           ...
           //here select the tabel from the database
            $sql = $this->conn->prepare("SELECT * FROM eigenaren");
            ...
            while($record = $sql->fetch()){
                ...
                <p  class='card-text'>" . $record->Naam. "</p>
                <p  class='card-text'>" . $record->Opleiding . "</p>
                <p  class='card-text'>" . $record->wharehouse . "</p>
                <p  class='card-text'>" . $record->licenses . "</p>
      ...
      $eigenaar = new  OverzichtEigenaar();
    ?>
