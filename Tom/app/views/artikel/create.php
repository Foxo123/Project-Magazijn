...
<body>
    <div class="container" style="padding-top: 25px;">
        ...
        <div class="row"> 
            <div class="col-12">
                <form action="<?= URLROOT; ?>/artikel/create_script" method="post">
                    <div class="row">
                        <div class="col-6">
                            ...
                            <input type="number" class="form-control" min="1" max="9999" name="aantal">
                        </div>
                        <div class="col-6">
                            ...
                            <div id="select">
                                ...
                                <input type="text" class="form-control" aria-label="Category" name="locatie">
                            </div>
                        </div>
                    </div>
                    <label class="form-label">Kosten</label>
                    <input type="number" name="kosten" step="0.01" class="form-control">
